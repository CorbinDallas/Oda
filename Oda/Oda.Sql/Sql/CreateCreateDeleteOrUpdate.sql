if not exists(select 0 from sys.objects where name = 'CreateDeleteOrUpdate' and type = 'P') begin
 declare @statement nvarchar(max) = 'create procedure CreateDeleteOrUpdate (
